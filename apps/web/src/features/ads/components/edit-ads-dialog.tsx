...
import { updateAds } from "../actions/update.action";
...
export function EditAdsDialog({ ads }: Props) {
  ...
  const [formData, setFormData] = useState({
    ...
    images: ads.images || [],
    postType: ads.postType || "",
    contactInformation: ads.contactInformation || "",
    isFeatured: ads.isFeatured || false,
    companyName: ads.companyName || "",
    occurrence: ads.occurrence || "",
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await updateAds(ads.id, formData);
      ...
      <DialogContent className="sm:max-w-[1000px] h-[80vh] flex flex-col">
        <form onSubmit={handleSubmit} className="flex flex-col h-full">
          <DialogHeader className="flex-shrink-0">
            ...
            <DialogDescription>
              Make changes to your ad listing below.
            </DialogDescription>
          </DialogHeader>
