      ...
      <DialogContent className="sm:max-w-[900px] h-[90vh] flex flex-col">
        <form onSubmit={handleSubmit} className="flex flex-col h-full">
          <DialogHeader className="flex-shrink-0 px-8 pt-6">
            ...
            <DialogDescription>
              Fill out the form to add a new sell or swap item. Required fields
              are marked with *.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="flex-grow overflow-y-auto px-8 py-6 space-y-6">
            ...
            <section className="space-y-4 p-6 border rounded-lg bg-muted/10">
                ...
                <div className="grid gap-2">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <button
                      ...
                      className="w-16 h-16 flex items-center justify-center border-2 border-dashed border-green-400 rounded hover:bg-green-50 transition"
